...
class TransformerModule(LightningModule):
    ...
    def training_epoch_end(self, outputs):
        if isinstance(self.score_fn, AbstractMahalanobisScore):
            ...
            np.save("/home/an/Documents/out-of-domain/Coding3/debug/mean.npy", self.score_fn.mean)
            np.save("/home/an/Documents/out-of-domain/Coding3/debug/cov.npy", self.score_fn.covariance_matrix)
        torch.save(self.transformer.state_dict(), "/home/an/Documents/out-of-domain/Coding3/debug/best_model.pt")
        avg_accuracy = torch.stack([x['log']['train_accuracy'] for x in outputs]).mean().item()
        return {
            'progress_bar': {
    ...
    def test_epoch_end(self, outputs):
        ...
        np.save("/home/an/Documents/out-of-domain/ood_scores.npy", ood_scores)
        return {
            f'test_loss': loss,
            'log': {
                **ood_metrics,
